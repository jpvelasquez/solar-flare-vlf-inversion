# RECONSTRUCTED PROVENANCE SNAPSHOT FOR SLURM JOB 13341497
# The exact pre-run file snapshot was not preserved. This copy was reconstructed
# from the later supplied script, its inline commented history, and the job
# 13341497 log, which states that the restart seed was job 13256787.
# No other changes were made by the repository curator.
...
function save_real_background_inversion_h5(
    ...
    h5open(output_h5, "w") do f
        ...
        HDF5.attributes(f)["initial_source"] = "previous_BBO_ASLS_reconstruction_13256787"
