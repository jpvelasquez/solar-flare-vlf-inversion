...
# Restart de perturbación PolyF3BG15742708.
# Seed = best de la primera inversión de perturbación:
#   new-perturbation-inversion_F3_nexp_polyF3BG15742708_FIXED_TPK_rel10_results_15824988.h5
# Dataset fuente: reconstruction/free_params == reco_free_params.
# Orden libre: [amp, tau_u_s, tau_d_s, eps_s, z0_km, hz_km]
const INITIAL_SEED_SOURCE = "new-perturbation-inversion_F3_nexp_polyF3BG15742708_FIXED_TPK_rel10_results_15824988.h5:reconstruction/free_params"
...
function save_results_h5_fixed_tpk(filename_hdf5;
    ...
    h5open(filename_hdf5, "w") do f
        ...
        HDF5.attributes(gi)["initial_seed_source"] = INITIAL_SEED_SOURCE
        ...
        HDF5.attributes(go)["initial_seed_source"] = INITIAL_SEED_SOURCE
        HDF5.attributes(go)["restart_from_jobid"] = "15824988"
        ...
        HDF5.attributes(f)["initial_seed_source"] = INITIAL_SEED_SOURCE
        HDF5.attributes(f)["restart_from_jobid"] = "15824988"
    end
end

jobid = get(ENV, "SLURM_JOB_ID", "nojid")
filename_hdf5 = "new-perturbation-inversion_F3_nexp_polyF3BG15742708_FIXED_TPK_restart_from_15824988_rel10_results_$(jobid).h5"
...
save_results_h5_fixed_tpk(
    ...
    m_seed = m_seed,
    m_reco = m_reco,
    reco_model = "F3_gaussiana_asimetrica_nexp_vertical_FIXED_TPK_FROM_POLYF3_DATA_RESTART_FROM_15824988",
...
println("Inversión terminada: restart F3+nexp con t_pk fijo desde separación PolyF3 y 6 parámetros libres.")
